...
export default function TermsPage() {
  return (
    <main className="legalPage">
      ...
      <p>
        We may modify, pause, or discontinue parts of the service at any time, including limits for
        stability or abuse prevention.
      </p>
      <h2>Disclaimer</h2>
      <p>
        The service is provided &quot;as is&quot; without warranties. We are not responsible for how
        users choose to use downloaded content.
      </p>
      <h2>Contact</h2>
      <p>
        Terms questions:{' '}
